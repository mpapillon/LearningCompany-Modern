    ...
    public class LearningCompanyInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<LearningCompanyContext>
    {
        protected override void Seed(LearningCompanyContext context)
        {
            ...
            var formations = new List<Formation>
            {
                ...
                new FormationPresentielle { Reference = "A03-012", Libelle = "Internet Explorer 10", NombreJours = 1, Prix = 600.0M, Decription = "Naviguer efficacement avec Internet Explorer 10", Theme = themes[1], Lieu = "Avenue de la République, Salle 3 - PARIS" },
                new FormationPresentielle { Reference = "A03-013", Libelle = "Mozilla Firefox", NombreJours = 1, Prix = 600.0M, Decription = "Naviguer efficacement avec Mozilla Firefox", Theme = themes[2], Lieu = "Avenue de la République, Salle 4 - PARIS" },
                new FormationPresentielle { Reference = "T06-034", Libelle = "Ordinateurs portables", NombreJours = 2, Prix = 1100.0M, Decription = "La prise en main des ordinateurs portables IBM sous Windows 7", Theme = themes[3], Lieu = "Avenue de la République, Salle 5 - PARIS" },
                new FormationPresentielle { Reference = "T01-010", Libelle = "Initiation à Excel", NombreJours = 2, Prix = 350.0M, Decription = "Apprendre les bases des formules des classeurs sous Exel", Theme = themes[0], Lieu = "Avenue de la République, Salle 2 - PARIS" },
                new FormationPresentielle { Reference = "T23-011", Libelle = "Le médecin généraliste", NombreJours = 2, Prix = 2300.0M, Decription = "Psychologie du médecin généraliste en milieu urbain", Theme = themes[8], Lieu = "Avenue de la République, Salle 3 - PARIS" },
                ...
                new FormationElearning { Reference = "T02-162", Libelle = "Documentation commerciale", NombreJours = 4, Prix = 500.0M, Decription = "Les documents de communication destinés aux médecins", Theme = themes[8], Url = "http://www.learningcompany.fr/4.htm" },
                new FormationElearning { Reference = "T02-163", Libelle = "Visite médicale", NombreJours = 4, Prix = 2000.0M, Decription = "Les étapes des entretiens du délégué médical avec le médecin", Theme = themes[8], Url = "http://www.learningcompany.fr/5.htm" },
                new FormationElearning { Reference = "T05-985", Libelle = "Tranfert de données", NombreJours = 1, Prix = 500.0M, Decription = "La transmission VPN des dossiers du délégué médical", Theme = themes[4], Url = "http://www.learningcompany.fr/6.htm" },
                new FormationElearning { Reference = "T02-162", Libelle = "Les effets secondaires", NombreJours = 2, Prix = 900.0M, Decription = "Prévention des effets secondaires du paracétamol", Theme = themes[5], Url = "http://www.learningcompany.fr/7.htm" },
                new FormationElearning { Reference = "T15-039", Libelle = "Interactions médicamenteuses", NombreJours = 1, Prix = 500.0M, Decription = "Introduction aux interactions médicamenteuses", Theme = themes[6], Url = "http://www.learningcompany.fr/8.htm" },
