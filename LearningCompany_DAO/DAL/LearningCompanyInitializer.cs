...
namespace LearningCompany.Entities
{
    public class LearningCompanyInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<LearningCompanyContext>
    {
        protected override void Seed(LearningCompanyContext context)
        {
            ...
            {
                new FormationPresentielle { Reference = "B21-005", Libelle = "Découvrir les nouveautés de Microsoft Word 2010", NombreJours = 3, Prix = 850.0M, Description = "Permet d''étudier les principales fonctionnalités de Microsoft Word", Theme = themes[0], Lieu = "Avenue de la République, Salle 1 - PARIS"},
                new FormationPresentielle { Reference = "B03-011", Libelle = "Excel 2010", NombreJours = 3, Prix = 800.0M, Description = "Permet de réaliser des classeurs Excel avancés avec Excel 2010", Theme = themes[0], Lieu = "Avenue de la République, Salle 2 - PARIS" },
                new FormationPresentielle { Reference = "A03-012", Libelle = "Internet Explorer 10", NombreJours = 1, Prix = 600.0M, Description = "Naviguer efficacement avec Internet Explorer 10", Theme = themes[1], Lieu = "Avenue de la République, Salle 3 - PARIS" },
                new FormationPresentielle { Reference = "A03-013", Libelle = "Mozilla Firefox", NombreJours = 1, Prix = 600.0M, Description = "Naviguer efficacement avec Mozilla Firefox", Theme = themes[2], Lieu = "Avenue de la République, Salle 4 - PARIS" },
                new FormationPresentielle { Reference = "T06-034", Libelle = "Ordinateurs portables", NombreJours = 2, Prix = 1100.0M, Description = "La prise en main des ordinateurs portables IBM sous Windows 7", Theme = themes[3], Lieu = "Avenue de la République, Salle 5 - PARIS" },
                new FormationPresentielle { Reference = "T01-010", Libelle = "Initiation à Excel", NombreJours = 2, Prix = 350.0M, Description = "Apprendre les bases des formules des classeurs sous Exel", Theme = themes[0], Lieu = "Avenue de la République, Salle 2 - PARIS" },
                new FormationPresentielle { Reference = "T23-011", Libelle = "Le médecin généraliste", NombreJours = 2, Prix = 2300.0M, Description = "Psychologie du médecin généraliste en milieu urbain", Theme = themes[8], Lieu = "Avenue de la République, Salle 3 - PARIS" },
                new FormationPresentielle { Reference = "T23-012", Libelle = "Le médecin généraliste", NombreJours = 2, Prix = 2300.0M, Description = "Psychologie du médecin généraliste en milieu rural", Theme = themes[8], Lieu = "Avenue de la République, Salle 1 - PARIS" },
                new FormationPresentielle { Reference = "D12-090", Libelle = "Le dédecin spécialiste", NombreJours = 2, Prix = 2300.0M, Description = "Psychologie du médecin spécialiste en milieu libéral", Theme = themes[8], Lieu = "Avenue de la République, Salle 4 - PARIS" },
                new FormationPresentielle { Reference = "D12-091", Libelle = "Le dédecin spécialiste", NombreJours = 2, Prix = 2300.0M, Description = "Psychologie du médecin spécialiste hospitalier", Theme = themes[8], Lieu = "Avenue de la République, Salle 5 - PARIS" },
                new FormationElearning { Reference = "T02-055", Libelle = "Les statines", NombreJours = 2, Prix = 1000.0M, Description = "Les statines de nouvelles générations pour le traitement du cholestérol", Theme = themes[7], Url = "http://www.learningcompany.fr/1.htm" },
                new FormationElearning { Reference = "T04-025", Libelle = "Les antibiotiques", NombreJours = 3, Prix = 1400.0M, Description = "Les antibiotiques de la catégorie Macrolid", Theme = themes[7], Url = "http://www.learningcompany.fr/2.htm" },
                new FormationElearning { Reference = "T02-059", Libelle = "Réglementation nationale", NombreJours = 2, Prix = 899.0M, Description = "Les nouveaux réglements Agence Nationale de Sécurité du Médicament (ANSM)", Theme = themes[8], Url = "http://www.learningcompany.fr/3.htm" },
                new FormationElearning { Reference = "T02-162", Libelle = "Documentation commerciale", NombreJours = 4, Prix = 500.0M, Description = "Les documents de communication destinés aux médecins", Theme = themes[8], Url = "http://www.learningcompany.fr/4.htm" },
                new FormationElearning { Reference = "T02-163", Libelle = "Visite médicale", NombreJours = 4, Prix = 2000.0M, Description = "Les étapes des entretiens du délégué médical avec le médecin", Theme = themes[8], Url = "http://www.learningcompany.fr/5.htm" },
                new FormationElearning { Reference = "T05-985", Libelle = "Tranfert de données", NombreJours = 1, Prix = 500.0M, Description = "La transmission VPN des dossiers du délégué médical", Theme = themes[4], Url = "http://www.learningcompany.fr/6.htm" },
                new FormationElearning { Reference = "T02-162", Libelle = "Les effets secondaires", NombreJours = 2, Prix = 900.0M, Description = "Prévention des effets secondaires du paracétamol", Theme = themes[5], Url = "http://www.learningcompany.fr/7.htm" },
                new FormationElearning { Reference = "T15-039", Libelle = "Interactions médicamenteuses", NombreJours = 1, Prix = 500.0M, Description = "Introduction aux interactions médicamenteuses", Theme = themes[6], Url = "http://www.learningcompany.fr/8.htm" },
                new FormationElearning { Reference = "T15-040", Libelle = "Interactions médicamenteuses", NombreJours = 1, Prix = 500.0M, Description = "Interactions médicamenteuses chez les personnes agées", Theme = themes[6], Url = "http://www.learningcompany.fr/9.htm" },
            };
